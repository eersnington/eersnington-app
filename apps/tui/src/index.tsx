        ...
        {(link, index) => {
          ...
          return (
            ...
            >
              ...
              <text fg={active() ? props.colors.accent : props.colors.lineNumbers}>
                {link.keybind}
              </text>
            </box>
          );
      ...
      : props.view === "help"
        ...
        : props.view === "themes"
          ...
          : props.view === "contact"
            ...
            : "~/main";
  const filetype = () =>
    props.view === "skill" ? "markdown" : props.view === "home" ? "main" : "text";
  const mode = () =>
    props.view === "home" || props.view === "skill" || props.view === "contact" ? "NORMAL" : "MENU";
